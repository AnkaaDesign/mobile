...
### ✅ 7. Configuration
**File:** `app.json`
- Has `"apiUrl": "http://192.168.0.13:3030"` in extra section
...
2. `app.json` gets bundled into APK with `apiUrl: "http://192.168.0.13:3030"` ✅
...
```
[App] Setting API URL from app.json : http://192.168.0.13:3030
...
API URL: http://192.168.0.13:3030    ← Should show LOCAL IP now!
--- Teste Básico ---
Status: ✅ SUCESSO
```
...
- [ ] `app.json` has `"apiUrl": "http://192.168.0.13:3030"`
...
- [ ] API server is running at 192.168.0.13:3030
