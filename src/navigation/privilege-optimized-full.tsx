...
const ALL_ROUTES = [
  ...
  { name: "estoque/pedidos/[orderId]/items/listar", title: "Listar Itens" },
  ...
  { name: "estoque/manutencao/agendamentos/listar", title: "Listar Agendamentos" },
  ...
  { name: "estoque/epi/listar", title: "Listar EPIs" },
  ...
  { name: "estoque/epi/agendamentos/listar", title: "Listar Agendamentos EPI" },
  ...
  { name: "estoque/epi/entregas/listar", title: "Listar Entregas EPI" },
  ...
  { name: "recursos-humanos/bonus-simulation", title: "Simulação de Bônus" },
  { name: "recursos-humanos/calculations", title: "Cálculos" },
  { name: "recursos-humanos/requisitions", title: "Requisições" },
  { name: "recursos-humanos/time-clock", title: "Ponto" },
  ...
  { name: "recursos-humanos/avisos/index", title: "Avisos" },
  ...
  { name: "recursos-humanos/epi/agendamentos/listar", title: "Listar Agendamentos EPI" },
  ...
  { name: "recursos-humanos/epi/entregas/listar", title: "Listar Entregas EPI" },
  ...
  { name: "recursos-humanos/epi/tamanhos/listar", title: "Listar Tamanhos EPI" },
  ...
  { name: "pintura/formulas/[formulaId]/componentes/listar", title: "Listar Componentes" },
  ...
  { name: "financeiro/clientes/listar", title: "Listar Clientes" },
  ...
  { name: "integracoes/secullum/calculos/listar", title: "Listar Cálculos" },
  { name: "integracoes/secullum/registros-ponto/index", title: "Registros de Ponto" },
  { name: "integracoes/secullum/registros-ponto/listar", title: "Listar Registros de Ponto" },
  { name: "integracoes/secullum/registros-ponto/detalhes/[id]", title: "Detalhes do Registro de Ponto" },
  { name: "integracoes/secullum/requisicoes/listar", title: "Listar Requisições" },
  ...
  { name: "servidor/registros-de-alteracoes/listar", title: "Listar Registros" },
  ...
  return (
    <Drawer
      ...
      screenOptions={({ navigation, route }) => {
        // Find the route config to get the proper title
        const routeConfig = accessibleRoutes.find(r => r.name === route.name);
    ...
    >
      {/* Register all accessible routes */}
      {accessibleRoutes.map((route) => (
        <Drawer.Screen
          ...
          options={{
            title: route.title,
            headerTitle: route.title, // Explicitly set header title
            drawerLabel: route.title, // Explicitly set drawer label
            lazy: true,
          }}
        />
      ))}
