...
const ALL_ROUTES = [
  ...
  { name: "pessoal/funcionarios/index", title: "Funcionários" },
  { name: "pessoal/funcionarios/listar", title: "Listar Funcionários" },
  { name: "pessoal/funcionarios/detalhes/[id]", title: "Detalhes do Funcionário" },
