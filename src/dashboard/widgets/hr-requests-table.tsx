...
// absence approval queue that lives at /recursos-humanos/requisicoes-ponto.
...
function HrRequestsTableRender({
  ...
  return (
    <WidgetCard
      ...
      viewAllHref="/(tabs)/recursos-humanos/requisicoes-ponto/listar"
...
function HrRequestsTableConfigComponent({
  ...
  const setFilters = <K extends keyof HrRequestsTableConfig["filters"]>(
    key: K,
    ...
    <View style={{ gap: 12 }}>
      ...
      <Section title="Aparência" defaultOpen>
        <AccentPicker
          ...
          onChange={(next) =>
            set("accent", next as HrRequestsTableConfig["accent"])
          }
        />
      </Section>
        ...
        <View style={{ gap: 4 }}>
          ...
          <Combobox
            ...
            onValueChange={(v: any) => {
              ...
              set(
                "sorts",
                [{ ...head, key: k }, ...tail] as HrRequestsTableConfig["sorts"],
              );
            }}
        ...
        <View style={{ gap: 4 }}>
          ...
          <Combobox
            ...
            onValueChange={(v: any) => {
              ...
              set(
                "sorts",
                [{ ...head, direction: dir }, ...tail] as HrRequestsTableConfig["sorts"],
              );
            }}
            options={[
