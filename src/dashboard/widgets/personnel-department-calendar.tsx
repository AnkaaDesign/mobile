...
const personnelDepartmentCalendarConfigSchema = z.object({
...
type PersonnelDepartmentCalendarConfig = z.infer<typeof personnelDepartmentCalendarConfigSchema>;

// ============================================================
// Render
// ============================================================

function PersonnelDepartmentCalendarRender({ config }: WidgetRenderProps<PersonnelDepartmentCalendarConfig>) {
  ...
  return (
    <WidgetCard
      ...
      viewAllHref={routes.personnelDepartment.holidays.calendar}
...
function PersonnelDepartmentCalendarConfigComponent({
  config,
  onChange,
}: WidgetConfigProps<PersonnelDepartmentCalendarConfig>) {
  const set = <K extends keyof PersonnelDepartmentCalendarConfig>(
    key: K,
    value: PersonnelDepartmentCalendarConfig[K],
  ) => onChange({ ...config, [key]: value });
  const setDisplay = <K extends keyof PersonnelDepartmentCalendarConfig["display"]>(
    key: K,
    value: PersonnelDepartmentCalendarConfig["display"][K],
  ) =>
    onChange({
      ...config,
      display: { ...config.display, [key]: value },
    });
  const setFilters = <K extends keyof PersonnelDepartmentCalendarConfig["filters"]>(
    key: K,
    value: PersonnelDepartmentCalendarConfig["filters"][K],
  ) =>
    onChange({
      ...config,
        ...
        <TabsContent value="appearance">
          <Section title="Aparência" defaultOpen>
            <AccentPicker
              ...
              onChange={(next) => set("accent", next as PersonnelDepartmentCalendarConfig["accent"])}
            />
          </Section>
...
export const personnelDepartmentCalendarWidget: WidgetDefinition<PersonnelDepartmentCalendarConfig> = {
  id: "home.hr-calendar",
  ...
  allowedHeights: [3, 4],
  defaultRows: 3,
  configSchema: personnelDepartmentCalendarConfigSchema,
  defaultConfig: {
  ...
  RenderComponent: PersonnelDepartmentCalendarRender,
  ConfigComponent: PersonnelDepartmentCalendarConfigComponent,
};
