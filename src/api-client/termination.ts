...
export class TerminationService {
  ...
  async getTerminations(params?: TerminationGetManyFormData): Promise<TerminationGetManyResponse> {
    const response = await apiClient.get<TerminationGetManyResponse>(this.basePath, { params });
    return response.data;
  }

  async getTerminationById(id: string, params?: any): Promise<TerminationGetUniqueResponse> {
    const response = await apiClient.get<TerminationGetUniqueResponse>(`${this.basePath}/${id}`, { params });
    return response.data;
  }

  // Mutation Operations
  async createTermination(data: TerminationCreateFormData, query?: any): Promise<TerminationCreateResponse> {
    const response = await apiClient.post<TerminationCreateResponse>(this.basePath, data, { params: query });
    return response.data;
  }

  async updateTermination(id: string, data: TerminationUpdateFormData, query?: any): Promise<TerminationUpdateResponse> {
    const response = await apiClient.put<TerminationUpdateResponse>(`${this.basePath}/${id}`, data, { params: query });
    return response.data;
  }
  ...
  async advanceTermination(id: string, data: TerminationAdvanceFormData = {}, query?: any): Promise<TerminationUpdateResponse> {
    const response = await apiClient.put<TerminationUpdateResponse>(`${this.basePath}/${id}/advance`, data, { params: query });
    return response.data;
  }
  ...
  async regressTermination(id: string, query?: any): Promise<TerminationUpdateResponse> {
    const response = await apiClient.put<TerminationUpdateResponse>(`${this.basePath}/${id}/regress`, {}, { params: query });
    return response.data;
  }
  ...
  // Document Operations
  async uploadTerminationDocument(id: string, data: TerminationDocumentUploadFormData, file: any): Promise<TerminationDocumentUpdateResponse> {
  ...
  async batchCreateTerminations(data: TerminationBatchCreateFormData, query?: any): Promise<TerminationBatchCreateResponse<Termination>> {
    const response = await apiClient.post<TerminationBatchCreateResponse<Termination>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }
  ...
  async batchUpdateTerminations(data: TerminationBatchUpdateFormData, query?: any): Promise<TerminationBatchUpdateResponse<Termination>> {
    const response = await apiClient.put<TerminationBatchUpdateResponse<Termination>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }

  async batchDeleteTerminations(data: TerminationBatchDeleteFormData, query?: any): Promise<TerminationBatchDeleteResponse> {
    const response = await apiClient.delete<TerminationBatchDeleteResponse>(`${this.basePath}/batch`, { data, params: query });
    return response.data;
  }
}
...
// Document Operations
export const uploadTerminationDocument = (id: string, data: TerminationDocumentUploadFormData, file: any) => terminationService.uploadTerminationDocument(id, data, file);
