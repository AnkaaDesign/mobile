...
export class LeaveService {
  ...
  async getLeaves(params?: LeaveGetManyFormData): Promise<LeaveGetManyResponse> {
    const response = await apiClient.get<LeaveGetManyResponse>(this.basePath, { params });
    return response.data;
  }

  async getLeaveById(id: string, params?: any): Promise<LeaveGetUniqueResponse> {
    const response = await apiClient.get<LeaveGetUniqueResponse>(`${this.basePath}/${id}`, { params });
    return response.data;
  }
  ...
  async createLeave(data: LeaveCreateFormData, query?: any): Promise<LeaveCreateResponse> {
    const response = await apiClient.post<LeaveCreateResponse>(this.basePath, data, { params: query });
    return response.data;
  }

  async updateLeave(id: string, data: LeaveUpdateFormData, query?: any): Promise<LeaveUpdateResponse> {
    const response = await apiClient.put<LeaveUpdateResponse>(`${this.basePath}/${id}`, data, { params: query });
    return response.data;
  }
  ...
  async finishLeave(id: string, data: { actualEndDate: Date }, query?: any): Promise<LeaveUpdateResponse> {
    const response = await apiClient.put<LeaveUpdateResponse>(`${this.basePath}/${id}/finish`, data, { params: query });
    return response.data;
  }
  ...
  async uploadLeaveFiles(id: string, files: any[], query?: any): Promise<LeaveUpdateResponse> {
  ...
  async batchCreateLeaves(data: LeaveBatchCreateFormData, query?: any): Promise<LeaveBatchCreateResponse<Leave>> {
    const response = await apiClient.post<LeaveBatchCreateResponse<Leave>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }

  async batchUpdateLeaves(data: LeaveBatchUpdateFormData, query?: any): Promise<LeaveBatchUpdateResponse<Leave>> {
    const response = await apiClient.put<LeaveBatchUpdateResponse<Leave>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }

  async batchDeleteLeaves(data: LeaveBatchDeleteFormData, query?: any): Promise<LeaveBatchDeleteResponse> {
    const response = await apiClient.delete<LeaveBatchDeleteResponse>(`${this.basePath}/batch`, { data, params: query });
    return response.data;
  }
}
...
export const uploadLeaveFiles = (id: string, files: any[], query?: any) => leaveService.uploadLeaveFiles(id, files, query);
