...
export class VacationService {
  ...
  // Period balance (remaining-days history). Keyed by vacation id — the server
  // reads the acquisitive dates from the row, avoiding client date drift.
...
// Period balance (remaining-days history) / Status Machine / Calculation
export const getVacationPeriodBalance = (vacationId: string) => vacationService.getPeriodBalance(vacationId);
