...
export class WarehouseLocationService {
  ...
  async getAllWarehouseLocations(params?: Omit<WarehouseLocationGetManyFormData, "page" | "limit">): Promise<WarehouseLocationGetManyResponse> {
    const response = await apiClient.get<WarehouseLocationGetManyResponse>(this.basePath, {
      params: {
        ...params,
        limit: 10000, // Large limit to get all locations
      },
    });
    return response.data;
  }
  ...
  async updateWarehouseLocation(id: string, data: WarehouseLocationUpdateFormData, query?: WarehouseLocationQueryFormData): Promise<WarehouseLocationUpdateResponse> {
...
export const updateWarehouseLocation = (id: string, data: WarehouseLocationUpdateFormData, query?: WarehouseLocationQueryFormData) => warehouseLocationService.updateWarehouseLocation(id, data, query);
