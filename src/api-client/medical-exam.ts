...
export class MedicalExamService {
  ...
  async getMedicalExams(params?: MedicalExamGetManyFormData): Promise<MedicalExamGetManyResponse> {
    const response = await apiClient.get<MedicalExamGetManyResponse>(this.basePath, { params });
    return response.data;
  }

  async getMedicalExamById(id: string, params?: any): Promise<MedicalExamGetUniqueResponse> {
    const response = await apiClient.get<MedicalExamGetUniqueResponse>(`${this.basePath}/${id}`, { params });
    return response.data;
  }
  ...
  async createMedicalExam(data: MedicalExamCreateFormData, query?: any): Promise<MedicalExamCreateResponse> {
    const response = await apiClient.post<MedicalExamCreateResponse>(this.basePath, data, { params: query });
    return response.data;
  }

  async updateMedicalExam(id: string, data: MedicalExamUpdateFormData, query?: any): Promise<MedicalExamUpdateResponse> {
    const response = await apiClient.put<MedicalExamUpdateResponse>(`${this.basePath}/${id}`, data, { params: query });
    return response.data;
  }
  ...
  async completeMedicalExam(id: string, data: MedicalExamCompleteFormData, query?: any): Promise<MedicalExamUpdateResponse> {
    const response = await apiClient.put<MedicalExamUpdateResponse>(`${this.basePath}/${id}/complete`, data, { params: query });
    return response.data;
  }

  // Upload do documento ASO (multipart, field "document")
  async uploadMedicalExamDocument(id: string, file: any, query?: any): Promise<MedicalExamUpdateResponse> {
  ...
  async batchCreateMedicalExams(data: MedicalExamBatchCreateFormData, query?: any): Promise<MedicalExamBatchCreateResponse<MedicalExam>> {
    const response = await apiClient.post<MedicalExamBatchCreateResponse<MedicalExam>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }
  ...
  async batchUpdateMedicalExams(data: MedicalExamBatchUpdateFormData, query?: any): Promise<MedicalExamBatchUpdateResponse<MedicalExam>> {
    const response = await apiClient.put<MedicalExamBatchUpdateResponse<MedicalExam>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }

  async batchDeleteMedicalExams(data: MedicalExamBatchDeleteFormData, query?: any): Promise<MedicalExamBatchDeleteResponse> {
    const response = await apiClient.delete<MedicalExamBatchDeleteResponse>(`${this.basePath}/batch`, { data, params: query });
    return response.data;
  }
}
...
export const uploadMedicalExamDocument = (id: string, file: any, query?: any) => medicalExamService.uploadMedicalExamDocument(id, file, query);
