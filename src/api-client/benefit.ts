...
export class BenefitService {
  ...
  async getBenefits(params?: BenefitGetManyFormData): Promise<BenefitGetManyResponse> {
    const response = await apiClient.get<BenefitGetManyResponse>(this.basePath, { params });
    return response.data;
  }

  async getBenefitById(id: string, params?: any): Promise<BenefitGetUniqueResponse> {
    const response = await apiClient.get<BenefitGetUniqueResponse>(`${this.basePath}/${id}`, { params });
    return response.data;
  }

  async createBenefit(data: BenefitCreateFormData, query?: any): Promise<BenefitCreateResponse> {
    const response = await apiClient.post<BenefitCreateResponse>(this.basePath, data, { params: query });
    return response.data;
  }

  async updateBenefit(id: string, data: BenefitUpdateFormData, query?: any): Promise<BenefitUpdateResponse> {
    const response = await apiClient.put<BenefitUpdateResponse>(`${this.basePath}/${id}`, data, { params: query });
    return response.data;
  }
  ...
  async batchCreateBenefits(data: BenefitBatchCreateFormData, query?: any): Promise<BenefitBatchCreateResponse<Benefit>> {
    const response = await apiClient.post<BenefitBatchCreateResponse<Benefit>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }

  async batchUpdateBenefits(data: BenefitBatchUpdateFormData, query?: any): Promise<BenefitBatchUpdateResponse<Benefit>> {
    const response = await apiClient.put<BenefitBatchUpdateResponse<Benefit>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }

  async batchDeleteBenefits(data: BenefitBatchDeleteFormData, query?: any): Promise<BenefitBatchDeleteResponse> {
    const response = await apiClient.delete<BenefitBatchDeleteResponse>(`${this.basePath}/batch`, { data, params: query });
    return response.data;
  }
}
...
export class UserBenefitService {
  ...
  async getUserBenefits(params?: UserBenefitGetManyFormData): Promise<UserBenefitGetManyResponse> {
    const response = await apiClient.get<UserBenefitGetManyResponse>(this.basePath, { params });
    return response.data;
  }

  async getUserBenefitById(id: string, params?: any): Promise<UserBenefitGetUniqueResponse> {
    const response = await apiClient.get<UserBenefitGetUniqueResponse>(`${this.basePath}/${id}`, { params });
    return response.data;
  }

  async createUserBenefit(data: UserBenefitCreateFormData, query?: any): Promise<UserBenefitCreateResponse> {
    const response = await apiClient.post<UserBenefitCreateResponse>(this.basePath, data, { params: query });
    return response.data;
  }

  async updateUserBenefit(id: string, data: UserBenefitUpdateFormData, query?: any): Promise<UserBenefitUpdateResponse> {
    const response = await apiClient.put<UserBenefitUpdateResponse>(`${this.basePath}/${id}`, data, { params: query });
    return response.data;
  }
  ...
  async suspendUserBenefit(id: string, query?: any): Promise<UserBenefitUpdateResponse> {
    const response = await apiClient.put<UserBenefitUpdateResponse>(`${this.basePath}/${id}/suspend`, undefined, { params: query });
    return response.data;
  }

  async reactivateUserBenefit(id: string, query?: any): Promise<UserBenefitUpdateResponse> {
    const response = await apiClient.put<UserBenefitUpdateResponse>(`${this.basePath}/${id}/reactivate`, undefined, { params: query });
    return response.data;
  }

  async terminateUserBenefit(id: string, data: { endDate: Date }, query?: any): Promise<UserBenefitUpdateResponse> {
    const response = await apiClient.put<UserBenefitUpdateResponse>(`${this.basePath}/${id}/terminate`, data, { params: query });
    return response.data;
  }
  ...
  async advanceUserBenefitInstallment(id: string, query?: any): Promise<UserBenefitUpdateResponse> {
    const response = await apiClient.put<UserBenefitUpdateResponse>(`${this.basePath}/${id}/advance-installment`, undefined, { params: query });
    return response.data;
  }

  // Declaração assinada (renúncia VT / autorização de desconto — multipart, field "declaration")
  async uploadUserBenefitDeclaration(id: string, file: any, query?: any): Promise<UserBenefitUpdateResponse> {
  ...
  async batchCreateUserBenefits(data: UserBenefitBatchCreateFormData, query?: any): Promise<UserBenefitBatchCreateResponse<UserBenefit>> {
    const response = await apiClient.post<UserBenefitBatchCreateResponse<UserBenefit>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }
  ...
  async batchUpdateUserBenefits(data: UserBenefitBatchUpdateFormData, query?: any): Promise<UserBenefitBatchUpdateResponse<UserBenefit>> {
    const response = await apiClient.put<UserBenefitBatchUpdateResponse<UserBenefit>>(`${this.basePath}/batch`, data, { params: query });
    return response.data;
  }

  async batchDeleteUserBenefits(data: UserBenefitBatchDeleteFormData, query?: any): Promise<UserBenefitBatchDeleteResponse> {
    const response = await apiClient.delete<UserBenefitBatchDeleteResponse>(`${this.basePath}/batch`, { data, params: query });
    return response.data;
  }
}
...
export const uploadUserBenefitDeclaration = (id: string, file: any, query?: any) => userBenefitService.uploadUserBenefitDeclaration(id, file, query);
