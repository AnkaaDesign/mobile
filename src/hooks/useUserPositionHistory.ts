// hooks/useUserPositionHistory.ts
// Histórico de cargos / Promoções (Departamento Pessoal)

import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import type { UseQueryOptions } from "@tanstack/react-query";
import { getUserPositionHistories, getUserPositionHistoryById, getUserSalaryAt, promoteUser } from "@/api-client";
import type { UserPositionHistoryGetManyFormData, UserPositionHistoryPromoteFormData } from "@/schemas";
import type { UserPositionHistoryGetManyResponse, UserPositionHistoryGetUniqueResponse, UserSalaryAtResponse } from "@/types";
import { userPositionHistoryKeys, userKeys, changeLogKeys } from "./queryKeys";
