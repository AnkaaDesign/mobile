...
export function usePrivileges() {
  ...
  const canManageProduction = canAccess([SECTOR_PRIVILEGES.PRODUCTION, SECTOR_PRIVILEGES.ADMIN]);
  ...
  const canCreateTasks = canAccess([SECTOR_PRIVILEGES.ADMIN]);
...
export const privilegeUtils = {
  ...
  combinations: {
    ...
    TASK_CREATION: [SECTOR_PRIVILEGES.ADMIN],
  } as const,
};
