...
/**
 * Hook for managing file preview modal state and navigation in React Native.
 *
 * @example
 * ```tsx
...
/**
 * Utility functions for file preview in React Native
 */
export const filePreviewUtils = {
  ...
  supportsHaptics: (): boolean => {
    // In React Native, we can generally assume haptic support
    // but you might want to add more specific checks here
    return true;
  },
};
