...
// ============================================================================
// FILTER SERIALIZATION AND DESERIALIZATION (for URL state if needed)
// ============================================================================

/**
 * Serialize filters to URL-safe format
 * Note: Less critical for mobile than web, but useful for deep linking
 */
...
// ============================================================================
// FILTER PRESET MANAGEMENT (Mobile - AsyncStorage)
// ============================================================================
...
/**
 * AsyncStorage implementation for filter presets (React Native)
 */
export class AsyncStorageFilterPresets implements FilterPresetStorage {
  ...
  async savePreset(preset: FilterDefinition): Promise<void> {
    try {
      ...
      await AsyncStorage.setItem(this.storageKey, JSON.stringify(updatedPresets));
    } catch (error) {
