...
export const GENERATED_ROUTE_PRIVILEGES: Record<string, GeneratedPrivilege> = {
  ...
  "/(tabs)/departamento-pessoal/colaboradores/listar": "HUMAN_RESOURCES",
  "/(tabs)/departamento-pessoal/colaboradores/cadastrar": "HUMAN_RESOURCES",
  "/(tabs)/departamento-pessoal/colaboradores/detalhes/[id]": "HUMAN_RESOURCES",
  "/(tabs)/departamento-pessoal/colaboradores/editar/[id]": "HUMAN_RESOURCES",
