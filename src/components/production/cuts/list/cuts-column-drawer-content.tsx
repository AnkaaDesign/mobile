...
import type { TableColumn } from "./cuts-table";

interface CutsColumnDrawerContentProps {
  columns: TableColumn[];
...
export function getDefaultVisibleColumns(): Set<string> {
  return new Set(["task", "filename", "status"]);
}

export const CutsColumnDrawerContent: React.FC<CutsColumnDrawerContentProps> = ({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
