...
interface ServiceOrderFilterDrawerV2Props {
  visible: boolean;
  onClose: () => void;
...
export function ServiceOrderFilterDrawerV2({ visible, onClose, onApply, currentFilters }: ServiceOrderFilterDrawerV2Props) {
