...
interface ColumnVisibilityDrawerV2Props {
  columns: ServiceOrderColumn[];
...
export function ServiceOrderColumnVisibilityDrawerV2({
  columns,
  visibleColumns,
  onVisibilityChange,
  open,
  onOpenChange
}: ColumnVisibilityDrawerV2Props) {
