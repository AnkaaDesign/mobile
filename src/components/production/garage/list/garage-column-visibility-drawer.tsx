...
interface GarageColumn {
  key: string;
  label: string;
}

export function getDefaultVisibleColumns(): Set<string> {
  return new Set(["name", "dimensions", "createdAt"]);
}

interface GarageColumnVisibilityDrawerProps {
...
export function GarageColumnVisibilityDrawer({
  columns,
  visibleColumns,
  onVisibilityChange,
  open,
  onOpenChange,
}: GarageColumnVisibilityDrawerProps) {
