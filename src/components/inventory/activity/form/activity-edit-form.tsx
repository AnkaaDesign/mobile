...
const REASON_OPTIONS = [
  ...
  { value: ACTIVITY_REASON.EXTERNAL_OPERATION, label: ACTIVITY_REASON_LABELS[ACTIVITY_REASON.EXTERNAL_OPERATION] },
  { value: ACTIVITY_REASON.EXTERNAL_OPERATION_RETURN, label: ACTIVITY_REASON_LABELS[ACTIVITY_REASON.EXTERNAL_OPERATION_RETURN] },
