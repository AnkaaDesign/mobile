...
interface ExternalOperationSummaryCardsProps {
...
export function ExternalOperationSummaryCards({
  withdrawerName,
  type,
  notes,
  selectedItems,
  ...
  prices,
  totalPrice = 0,
}: ExternalOperationSummaryCardsProps) {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Card style={styles.card}>
        ...
        <View style={styles.content}>
          ...
          <View style={[styles.infoRow, { backgroundColor: colors.muted }]}>
            ...
            <Text style={styles.infoLabel}>Tipo de Operação</Text>
            <Badge
              variant={
            ...
            >
              {EXTERNAL_OPERATION_TYPE_LABELS[type]}
            </Badge>
          </View>
      ...
      <Card style={styles.card}>
        <View style={[styles.header, { borderBottomColor: colors.border }]}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.title}>Itens da Operação</Text>
          </View>
      ...
      {canViewPrices && type === EXTERNAL_OPERATION_TYPE.CHARGEABLE && (
        <Card style={styles.card}>
          <View style={[styles.header, { borderBottomColor: colors.border }]}>
            <View style={styles.headerLeft}>
          ...
          <View style={styles.content}>
            ...
            <View style={[styles.grandTotal, { backgroundColor: `#10b98120` }]}>
              <Text style={styles.grandTotalLabel}>Total da Operação:</Text>
