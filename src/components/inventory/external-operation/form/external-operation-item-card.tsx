...
interface ExternalOperationItemCardProps {
  itemId: string;
  itemName: string;
...
export function ExternalOperationItemCard({
  itemName,
  itemCode,
  itemBrand,
  itemCategory,
  ...
  onPriceChange,
  onRemove,
}: ExternalOperationItemCardProps) {
  ...
  return (
    <View style={[styles.container, { borderColor: colors.border }]}>
      ...
      <View style={styles.inputs}>
        ...
        {canViewPrices && type === EXTERNAL_OPERATION_TYPE.CHARGEABLE && onPriceChange && (
          <View style={styles.inputWrapper}>
