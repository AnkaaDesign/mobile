  ...
  const SkeletonRow = () => (
    <Animated.View style={StyleSheet.flatten([styles.row, animatedStyle])}>
      <View style={styles.rowContent}>
        {/* Item Icon Skeleton */}
        <View style={StyleSheet.flatten([styles.iconSkeleton, { backgroundColor: colors.muted }])} />

        {/* Item Info Skeleton */}
        <View style={styles.itemInfo}>
          <View style={StyleSheet.flatten([styles.skeletonLine, { backgroundColor: colors.muted, width: 140 }])} />
          <View style={StyleSheet.flatten([styles.skeletonLine, { backgroundColor: colors.muted, width: 90 }])} />
        </View>

        {/* User & Quantity Skeleton */}
        <View style={styles.middleSection}>
          <View style={StyleSheet.flatten([styles.skeletonLine, { backgroundColor: colors.muted, width: 100 }])} />
          <View style={StyleSheet.flatten([styles.skeletonLine, { backgroundColor: colors.muted, width: 50 }])} />
        </View>
