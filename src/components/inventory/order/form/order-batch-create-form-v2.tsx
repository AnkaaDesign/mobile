...
interface OrderBatchCreateFormV2Props {
  onSubmit: (data: {
    supplierId: string;
    forecast: Date;
    notes?: string;
...
export function OrderBatchCreateFormV2({
  onSubmit,
  onCancel,
  isSubmitting = false,
}: OrderBatchCreateFormV2Props) {
        ...
        {multiStepForm.currentStep === 2 && (
          <View style={styles.itemSelectorContainer}>
            <ItemSelectorTable
              ...
              page={multiStepForm.page}
              pageSize={multiStepForm.pageSize}
              totalRecords={multiStepForm.totalRecords}
              onPageChange={multiStepForm.setPage}
              onTotalRecordsChange={multiStepForm.setTotalRecords}
              allowZeroStock
...
export default OrderBatchCreateFormV2;
