...
interface UserColumnVisibilityDrawerProps {
...
const ALL_COLUMNS: UserColumn[] = [
  { key: "name", header: "Nome", sortable: true },
  { key: "email", header: "Email", sortable: true },
  { key: "cpf", header: "CPF", sortable: true },
  { key: "status", header: "Status", sortable: true },
  { key: "position", header: "Cargo", sortable: true },
  { key: "sector", header: "Setor", sortable: true },
  { key: "createdAt", header: "Criado em", sortable: true },
  { key: "updatedAt", header: "Atualizado em", sortable: true },
];

export function UserColumnVisibilityDrawer({
  visibleColumns,
  onVisibilityChange,
  open,
  onOpenChange
}: UserColumnVisibilityDrawerProps) {
  ...
  const filteredColumns = useMemo(() => {
    ...
    return ALL_COLUMNS.filter((col) => col.header.toLowerCase().includes(query));
  }, [searchQuery]);
