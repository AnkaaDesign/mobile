...
interface EmployeeFilterTagsProps {
  filters: any;
  searchText?: string;
...
export function EmployeeFilterTags({ filters, searchText, onFilterChange, onSearchChange, onClearAll }: EmployeeFilterTagsProps) {
