...
interface BonificationsCardProps {
  employee: User;
  maxItems?: number;
}

export function BonificationsCard({ employee, maxItems = 5 }: BonificationsCardProps) {
    ...
    >
      <View style={styles.content}>
        {bonuses.length === 0 ? (
          <EmptyState
            icon="currency-dollar"
            title="Nenhuma bonificação registrada"
            description="Este colaborador ainda não possui bonificações registradas."
          />
        ) : (
          <>
            {/* Summary Stats */}
