...
import { getDefaultVisibleColumns } from './sector-table';
...
interface SectorColumnVisibilityDrawerProps {
...
export function SectorColumnVisibilityDrawer({
  columns,
  visibleColumns,
  onVisibilityChange,
  open,
  onOpenChange
}: SectorColumnVisibilityDrawerProps) {
