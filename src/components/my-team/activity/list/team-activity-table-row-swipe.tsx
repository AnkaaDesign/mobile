...
const TeamActivityTableRowSwipeComponent = ({ children, activityId, activityDescription, onEdit, onDelete, style, disabled = false }: TeamActivityTableRowSwipeProps) => {
  ...
  const handleDeletePress = useCallback(() => {
    Alert.alert("Confirmar exclusão", `Tem certeza que deseja excluir "${activityDescription}"?`, [
      {
        text: "Cancelar",
        style: "cancel",
  ...
  if (!children || (typeof children !== "object" && typeof children !== "string" && typeof children !== "number" && typeof children !== "function")) {
    console.warn("TeamActivityTableRowSwipe: children prop is invalid or undefined:", typeof children);
