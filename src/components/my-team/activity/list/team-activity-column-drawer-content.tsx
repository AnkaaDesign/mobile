...
interface TeamActivityColumnDrawerContentProps {
...
export function TeamActivityColumnDrawerContent({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
}: TeamActivityColumnDrawerContentProps) {
  ...
  const handleClear = useCallback(() => {
    setLocalVisible(new Set(["itemCode", "itemName", "operation", "quantity", "userName"]));
  }, []);
