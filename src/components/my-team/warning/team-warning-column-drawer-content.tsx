...
interface TeamWarningColumnDrawerContentProps {
...
export function TeamWarningColumnDrawerContent({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
}: TeamWarningColumnDrawerContentProps) {
  ...
  const handleClear = useCallback(() => {
    setLocalVisible(new Set(["collaboratorName", "category", "severity", "followUpDate"]));
  }, []);
