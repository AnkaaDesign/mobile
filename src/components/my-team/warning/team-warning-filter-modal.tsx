...
interface TeamWarningFilterModalProps {
  visible: boolean;
  onClose: () => void;
  onApply: (filters: TeamWarningFilters) => void;
  currentFilters: TeamWarningFilters;
  teamMembers: User[];
}

export const TeamWarningFilterModal = ({ visible, onClose, onApply, currentFilters, teamMembers }: TeamWarningFilterModalProps) => {
  const { colors } = useTheme();
  const [filters, setFilters] = useState<TeamWarningFilters>(currentFilters);
      ...
      <View style={styles.modalOverlay}>
        <ThemedView style={[styles.modalContent, { backgroundColor: colors.background }]}>
          ...
          <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
            <ThemedText style={styles.modalTitle}>Filtrar Advertências</ThemedText>
