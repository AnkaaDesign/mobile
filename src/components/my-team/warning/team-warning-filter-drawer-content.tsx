...
import { IconFilter, IconX, IconAlertTriangle, IconTag, IconUsers, IconCalendarPlus } from '@tabler/icons-react-native';
...
interface TeamWarningFilterDrawerContentProps {
  filters: TeamWarningFilters;
  onFiltersChange: (filters: TeamWarningFilters) => void;
  onClear: () => void;
...
export function TeamWarningFilterDrawerContent({
  ...
  const [localFilters, setLocalFilters] = useState<TeamWarningFilters>(() => ({
