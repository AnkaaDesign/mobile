...
interface TeamMemberColumnDrawerContentProps {
  columns: TeamMemberColumn[];
  visibleColumns: Set<string>;
  onVisibilityChange: (columns: Set<string>) => void;
  onClose?: () => void;
}

export function TeamMemberColumnDrawerContent({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
}: TeamMemberColumnDrawerContentProps) {
  ...
  const handleClear = useCallback(() => {
    setLocalVisible(new Set(["name", "position"]));
  }, []);
