...
interface ItemSelectorTableV2Props {
...
export function ItemSelectorTableV2({
  selectedItems,
  quantities,
  onSelectItem,
  onQuantityChange,
  ...
  const columnWidths = useMemo(() => {
    ...
    const quantityColWidth = showQuantityInput ? 70 : 0;
    const availableWidth = screenWidth - spacing.md * 2 - checkboxWidth - quantityColWidth;
    const totalRatio = displayColumns.reduce((sum, col) => sum + col.width, 0);
    return displayColumns.map((col) =>
      Math.floor((availableWidth * col.width) / totalRatio)
    );
  }, [displayColumns, screenWidth, showQuantityInput]);
    ...
    <View style={[styles.container, style]}>
      ...
      <View style={[styles.tableCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
        ...
        <View style={[styles.tableHeader, { borderBottomColor: colors.border }]}>
          <View style={styles.checkboxCell}>
            <ThemedText style={[styles.headerText, { color: colors.mutedForeground }]}>#</ThemedText>
          </View>
...
const styles = StyleSheet.create({
  ...
  checkboxCell: { width: 50, alignItems: "center", justifyContent: "center", paddingHorizontal: 12 },
...
export default ItemSelectorTableV2;
