...
import { IconCircleCheck, IconCircleX, IconInfoCircle } from "@tabler/icons-react-native";
...
export function DeliveryCompatibilityCard({ ppeSize }: DeliveryCompatibilityCardProps) {
  ...
  const ppeTypeMapping: Array<{
    ...
    { type: PPE_TYPE.SHIRT, label: PPE_TYPE_LABELS[PPE_TYPE.SHIRT], sizeValue: ppeSize.shirts, isAvailable: !!ppeSize.shirts },
    { type: PPE_TYPE.PANTS, label: PPE_TYPE_LABELS[PPE_TYPE.PANTS], sizeValue: ppeSize.pants, isAvailable: !!ppeSize.pants },
    { type: PPE_TYPE.BOOTS, label: PPE_TYPE_LABELS[PPE_TYPE.BOOTS], sizeValue: ppeSize.boots, isAvailable: !!ppeSize.boots },
    { type: PPE_TYPE.SLEEVES, label: PPE_TYPE_LABELS[PPE_TYPE.SLEEVES], sizeValue: ppeSize.sleeves, isAvailable: !!ppeSize.sleeves },
    { type: PPE_TYPE.MASK, label: PPE_TYPE_LABELS[PPE_TYPE.MASK], sizeValue: ppeSize.mask, isAvailable: !!ppeSize.mask },
    { type: PPE_TYPE.GLOVES, label: PPE_TYPE_LABELS[PPE_TYPE.GLOVES], sizeValue: ppeSize.gloves, isAvailable: !!ppeSize.gloves },
    { type: PPE_TYPE.RAIN_BOOTS, label: PPE_TYPE_LABELS[PPE_TYPE.RAIN_BOOTS], sizeValue: ppeSize.rainBoots, isAvailable: !!ppeSize.rainBoots },
  ];
  ...
  return (
    <DetailCard title="Compatibilidade de Entregas" icon="package">
