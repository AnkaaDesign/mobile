...
const TABS: TimeClockTab[] = [
  { label: "Colaborador", route: "/recursos-humanos/controle-ponto/colaborador" },
  { label: "Dia", route: "/recursos-humanos/controle-ponto/dia" },
  { label: "Edição", route: "/recursos-humanos/controle-ponto/edicao", hrOnly: true },
  { label: "Ausências", route: "/recursos-humanos/controle-ponto/ausencias" },
  { label: "Fechamento", route: "/recursos-humanos/controle-ponto/fechamento", hrOnly: true },
  { label: "Requisições", route: "/recursos-humanos/requisicoes-ponto/listar", hrOnly: true },
];
