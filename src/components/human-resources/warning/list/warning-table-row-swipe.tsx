...
const WarningTableRowSwipeComponent = ({
  ...
  const handleDeletePress = useCallback(() => {
    Alert.alert(
      "Confirmar exclusão",
      `Tem certeza que deseja excluir a advertência de "${collaboratorName}"?`,
      [
        {
          text: "Cancelar",
          style: "cancel",
  ...
  }, [warningId, collaboratorName, onDelete]);
  ...
  if (!children || (typeof children !== "object" && typeof children !== "string" && typeof children !== "number" && typeof children !== "function")) {
    console.warn("WarningTableRowSwipe: children prop is invalid or undefined:", typeof children);
