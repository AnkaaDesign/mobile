...
const MyWarningTableRowSwipeComponent = ({ children, warningId, warningReason, onEdit, onDelete, style, disabled = false }: MyWarningTableRowSwipeProps) => {
  ...
  const handleDeletePress = useCallback(() => {
    Alert.alert("Confirmar exclusão", `Tem certeza que deseja excluir a advertência "${warningReason}"?`, [
      {
        text: "Cancelar",
        style: "cancel",
  ...
  }, [warningId, warningReason, onDelete]);
  ...
  if (!children || (typeof children !== "object" && typeof children !== "string" && typeof children !== "number" && typeof children !== "function")) {
    console.warn("MyWarningTableRowSwipe: children prop is invalid or undefined:", typeof children);
