...
interface MyWarningColumnDrawerContentProps {
...
export function MyWarningColumnDrawerContent({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
}: MyWarningColumnDrawerContentProps) {
  ...
  const handleClear = useCallback(() => {
    setLocalVisible(new Set(["severity", "category", "reason"]));
  }, []);
