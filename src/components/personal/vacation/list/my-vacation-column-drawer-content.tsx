...
interface MyVacationColumnDrawerContentProps {
  columns: VacationColumn[];
  visibleColumns: Set<string>;
  onVisibilityChange: (columns: Set<string>) => void;
  onClose?: () => void;
}

export function MyVacationColumnDrawerContent({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
}: MyVacationColumnDrawerContentProps) {
  ...
  const handleClear = useCallback(() => {
    setLocalVisible(new Set(["period", "daysRequested", "status"]));
  }, []);
