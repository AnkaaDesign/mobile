...
interface MyBorrowColumnDrawerContentProps {
...
export function MyBorrowColumnDrawerContent({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
}: MyBorrowColumnDrawerContentProps) {
  ...
  const handleClear = useCallback(() => {
    setLocalVisible(new Set(["item", "status", "createdAt"]));
  }, []);
