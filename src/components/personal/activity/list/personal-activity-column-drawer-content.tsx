...
interface PersonalActivityColumnDrawerContentProps {
...
export function PersonalActivityColumnDrawerContent({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
}: PersonalActivityColumnDrawerContentProps) {
  ...
  const handleClear = useCallback(() => {
    // Personal activities default: item, quantity, date
    setLocalVisible(new Set(["itemName", "quantity", "createdAt"]));
  }, []);
