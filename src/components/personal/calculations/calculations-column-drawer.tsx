...
interface CalculationsColumnDrawerProps {
...
export function CalculationsColumnDrawer({
  columns,
  visibleColumns,
  onVisibilityChange,
  onClose,
  defaultColumns = ["date", "entrada1", "saida1", "entrada2", "saida2", "normais", "ex50", "ex100", "dsr", "ajuste"],
}: CalculationsColumnDrawerProps) {
            ...
            return (
              <View key={column.key} style={styles.columnItem}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <ThemedText style={styles.columnTitle}>{column.label}</ThemedText>
                </TouchableOpacity>
