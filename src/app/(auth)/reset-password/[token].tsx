...
export default function ResetPasswordScreen() {
        ...
        Alert.alert("Código inválido", "O código informado é inválido ou expirou. Solicite um novo código.", [
          {
            ...
            onPress: () => {
              router.replace({
                pathname: routeToMobilePath(routes.authentication.recoverPassword) as any,
  ...
  React.useEffect(() => {
    if (!contactValue || !codeValue) {
      router.replace(routeToMobilePath(routes.authentication.recoverPassword) as any);
    }
                ...
                <CardFooter style={{ paddingTop: spacing.lg, gap: spacing.md }}>
                  ...
                  <View style={{ alignItems: "center" }}>
                    <ThemedText
                      ...
                      size="sm"
                      weight="semibold"
                      onPress={() => router.push(routeToMobilePath(routes.authentication.login) as any)}
