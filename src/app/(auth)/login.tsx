...
export default function LoginScreen() {
  ...
  const onSubmit = async (data: SignInFormData) => {
    ...
    try {
      ...
      // After successful login, navigate to index which will handle proper routing
        ...
        Alert.alert("Verificação necessária", "Sua conta precisa ser verificada antes de continuar.", [
          {
            ...
            onPress: () => {
              ...
              router.push({
                pathname: routeToMobilePath(routes.authentication.verifyCode) as any,
                params: {
                  contact: data.contact,
                  returnTo: routeToMobilePath(routes.authentication.login),
                },
              });
            },
          },
                  ...
                  <View style={{ gap: spacing.sm }}>
                    ...
                    <View style={{ alignItems: "flex-end", marginTop: spacing.sm }}>
                      <ThemedText
                        variant="primary"
                        size="sm"
                        onPress={() => router.push(routeToMobilePath(routes.authentication.recoverPassword) as any)}
                  ...
                  <View style={{ alignItems: "center" }}>
                    <ThemedText variant="muted" size="sm" style={{ textAlign: "center" }}>
                      ...
                      <ThemedText
                        ...
                        size="sm"
                        weight="semibold"
                        onPress={() => router.push(routeToMobilePath(routes.authentication.register) as any)}
                        style={{ textDecorationLine: "underline" }}
                      >
                        Cadastre-se
                      </ThemedText>
