    ...
    return (
      <ScrollView style={{ flex: 1, backgroundColor: colors.background }}>
        <View style={{ padding: 16, gap: 20 }}>
          ...
          {/* Métricas Administrativas skeleton — 6 cards in 2x3 grid */}
          <View style={{ gap: 12 }}>
            <Skeleton style={{ height: 22, width: 200, borderRadius: 4 }} />
            <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 8 }}>
              {[1, 2, 3, 4, 5, 6].map((i) => (
          ...
          {/* Status dos Usuários skeleton — card with 3 progress bars */}
          <View style={{ gap: 12 }}>
          ...
          {/* Colaboradores por Cargo skeleton — card with 5 progress bar rows */}
          <View style={{ gap: 12 }}>
