...
import {
  ...
  CollaboratorCard,
  DocumentCard,
} from "@/components/human-resources/medical-exam/detail";
import { MedicalExamCompleteDialog } from "@/components/human-resources/medical-exam/complete";

const ROOT = mobileRoute(routes.humanResources.occupationalHealth.medicalExams.root);
  ...
  return (
    <>
      <DetailScreen<MedicalExam>
        ...
        editRoute={(e) => mobileRoute(routes.humanResources.occupationalHealth.medicalExams.edit(e.id))}
        deleteAction={{
