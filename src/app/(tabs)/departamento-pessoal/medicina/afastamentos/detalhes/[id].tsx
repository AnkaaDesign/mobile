...
} from "@/components/personnel-department/leave/detail";
import { FinishLeaveDialog } from "@/components/personnel-department/leave/finish-leave-dialog";

const ROOT = mobileRoute(routes.personnelDepartment.occupationalHealth.leaves.root);
  ...
  return (
    <>
      <DetailScreen<Leave>
        ...
        editRoute={(l) => mobileRoute(routes.personnelDepartment.occupationalHealth.leaves.edit(l.id))}
        deleteAction={{
