...
import { UserPositionHistoryCard } from "@/components/personnel-department/user-position-history";
...
export default function EmployeeDetailScreen() {
  ...
  const handleEdit = () => {
    if (employee) {
      nav.push(mobileRoute(routes.personnelDepartment.employees.edit(employee.id)));
    }
  };
