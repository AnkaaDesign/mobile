...
import { DeliveryCard, EmployeeCard, ItemDetailsCard } from "@/components/personnel-department/ppe/delivery/detail";
import { PpeDeliveryDetailSkeleton } from "@/components/personnel-department/ppe/delivery/skeleton";
...
export default function HRPPEDeliveryDetailsScreen() {
  ...
  const handleEdit = () => {
    if (delivery) {
      nav.push(mobileRoute(routes.personnelDepartment.ppe.deliveries.edit(delivery.id)));
    }
  };
