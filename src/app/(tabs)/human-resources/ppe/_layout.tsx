...
export default function HumanResourcesPPELayout() {
  return (
    <Stack
      screenOptions={{
    ...
    >
      ...
      <Stack.Screen name="sizes" options={{ title: "Tamanhos de EPI" }} />
      <Stack.Screen name="sizes/create" options={{ title: "Cadastrar Tamanho" }} />
      <Stack.Screen name="sizes/list" options={{ title: "Listar Tamanhos" }} />
      <Stack.Screen name="sizes/details/[id]" options={{ title: "Detalhes do Tamanho" }} />
      <Stack.Screen name="sizes/edit/[id]" options={{ title: "Editar Tamanho" }} />
    </Stack>
  );
}
