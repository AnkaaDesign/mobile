...
export default function AdministrationEmployeesListScreen() {
  ...
  const { items: employees, isLoading, error, refetch, isRefetching, loadMore, canLoadMore, isFetchingNextPage, totalItemsLoaded, refresh } = useUsersInfiniteMobile(queryParams);
  ...
  const handleDeleteEmployee = useCallback(
    async (employeeId: string) => {
      try {
        ...
        Alert.alert("Erro", "Não foi possível excluir o colaborador. Tente novamente.");
      }
    },
  ...
  return (
    <ThemedView style={[styles.container, { backgroundColor: colors.background, paddingBottom: insets.bottom }]}>
      ...
      {/* Items count */}
      {hasEmployees && <ItemsCountDisplay loadedCount={totalItemsLoaded} totalCount={undefined} isLoading={isFetchingNextPage} />}
