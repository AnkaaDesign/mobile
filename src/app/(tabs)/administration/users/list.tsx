...
export default function UsersListScreen() {
  ...
  const handleEditUser = (userId: string) => {
    router.push(routeToMobilePath(routes.administration.users.edit(userId)) as any);
  };
    ...
    <ThemedView style={[styles.container, { backgroundColor: colors.background, paddingBottom: insets.bottom }]}>
      ...
      {hasUsers ? (
        <TableErrorBoundary onRetry={handleRefresh}>
          <EmployeeTable
            employees={users}
            onEmployeePress={handleUserPress}
            onEmployeeEdit={handleEditUser}
            onEmployeeDelete={handleDeleteUser}
            onEmployeeView={handleUserPress}
