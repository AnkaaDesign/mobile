...
export default function LoanListScreen() {
  ...
  const handleCreateBorrow = () => {
    router.push(routeToMobilePath(routes.inventory.loans.create));
  };

  const handleBorrowPress = (borrowId: string) => {
    router.push(routeToMobilePath(routes.inventory.loans.details(borrowId)));
  };

  const handleEditBorrow = (borrowId: string) => {
    router.push(routeToMobilePath(routes.inventory.loans.edit(borrowId)));
  };
