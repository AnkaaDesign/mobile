...
export default function BorrowListScreen() {
  ...
  const handleCreateBorrow = () => {
    router.push(routeToMobilePath(routes.inventory.loans.create) as any);
  };

  const handleBorrowPress = (borrowId: string) => {
    router.push(routeToMobilePath(routes.inventory.loans.details(borrowId)) as any);
  };

  const handleEditBorrow = (borrowId: string) => {
    router.push(routeToMobilePath(routes.inventory.loans.edit(borrowId)) as any);
  };
