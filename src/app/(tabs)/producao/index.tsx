    ...
    return (
      <ScrollView style={{ flex: 1, backgroundColor: colors.background }}>
        <View style={{ padding: 16, gap: 20 }}>
          ...
          {/* Métricas de Produção skeleton — 6 cards in 2x3 grid */}
          <View style={{ gap: 12 }}>
          ...
          {/* Status das Tarefas skeleton — card with 4 progress bars */}
          <View style={{ gap: 12 }}>
          ...
          {/* Tarefas por Setor skeleton — card with 5 progress bar rows */}
          <View style={{ gap: 12 }}>
            <Skeleton style={{ height: 22, width: 160, borderRadius: 4 }} />
            <View style={{ backgroundColor: colors.card, borderRadius: 8, borderWidth: 1, borderColor: colors.border, padding: 12, gap: 10 }}>
              {[1, 2, 3, 4, 5].map((i) => (
