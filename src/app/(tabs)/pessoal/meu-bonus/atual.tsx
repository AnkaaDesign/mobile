  ...
  return (
    <ThemedView style={[styles.container, { backgroundColor: colors.background, paddingBottom: insets.bottom }]}>
      <ScrollView style={styles.scrollView} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={handleRefresh} colors={[colors.primary]} tintColor={colors.primary} />}>
              ...
              return (
                <TouchableOpacity key={extra.id || `extra-${index}`} style={styles.detailRow} onPress={() => openRulesModal(extra.reference)} activeOpacity={0.7}>
                  <View style={{ flex: 1, paddingRight: 8, flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                    <ThemedText style={[styles.detailLabel, { color: '#059669', flexShrink: 1 }]}>
        ...
        <Card style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.detailRow}>
              ...
              <ThemedText style={styles.detailValue}>
                {bonificationStats.hasDetails ? bonificationStats.total : (bonus.tasks?.length || '-')}
              </ThemedText>
            </View>
            <View style={styles.detailRow}>
        ...
        <Card style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <ThemedText style={styles.sectionTitle}>Status das Bonificações</ThemedText>
