            ...
            <Card>
              <CardContent style={styles.errorContent}>
                <View style={StyleSheet.flatten([styles.errorIcon, { backgroundColor: colors.muted }])}>
                  <IconTags size={32} color={colors.mutedForeground} />
                </View>
              ...
              <View style={styles.infoSection}>
                ...
                <View style={styles.infoGrid}>
                  <View style={StyleSheet.flatten([styles.infoRow, { backgroundColor: colors.muted + "30" }])}>
                    ...
                    <ThemedText style={StyleSheet.flatten([styles.infoValue, { color: colors.foreground }])}>{brand.name}</ThemedText>
                  </View>
                  <View style={StyleSheet.flatten([styles.infoRow, { backgroundColor: colors.muted + "30" }])}>
              ...
              <View style={StyleSheet.flatten([styles.infoSection, styles.borderTop])}>
                ...
                <View style={styles.timestampGrid}>
                  <View style={styles.timestampItem}>
                    ...
                    <ThemedText style={StyleSheet.flatten([styles.timestampValue, { color: colors.foreground }])}>{formatDate(brand.createdAt)}</ThemedText>
                  </View>
                  <View style={styles.timestampItem}>
                    <View style={styles.timestampRow}>
                      <IconCalendar size={16} color={colors.mutedForeground} />
                    ...
                    <ThemedText style={StyleSheet.flatten([styles.timestampValue, { color: colors.foreground }])}>{formatDate(brand.updatedAt)}</ThemedText>
                  </View>
                </View>
              </View>
            </View>
            ...
            <View style={styles.cardContent}>
              {items.length === 0 ? (
                <View style={styles.emptyState}>
                  ...
                  <ThemedText style={StyleSheet.flatten([styles.emptyText, { color: colors.mutedForeground }])}>Nenhum produto associado a esta marca.</ThemedText>
                </View>
              ) : (
                <>
                  {/* Statistics Summary */}
                          ...
                          <View style={[styles.itemCard, { backgroundColor: isDark ? colors.card : colors.background, borderColor: colors.border }]}>
                            <View style={styles.itemCardContent}>
                              <View>
                                ...
                                {item.category && (
                                  <ThemedText style={StyleSheet.flatten([styles.itemCardCategory, { color: colors.mutedForeground }])} numberOfLines={1}>
                                    {item.category.name}
                                  </ThemedText>
                                )}
