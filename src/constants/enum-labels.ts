...
export const EXTERNAL_WITHDRAWAL_TYPE_LABELS: Record<EXTERNAL_WITHDRAWAL_TYPE, string> = {
  ...
  [EXTERNAL_WITHDRAWAL_TYPE.COURTESY]: "Cortesia",
};
...
export const NOTIFICATION_CHANNEL_LABELS: Record<NOTIFICATION_CHANNEL, string> = {
  ...
  [NOTIFICATION_CHANNEL.MOBILE_PUSH]: "Push Mobile",
...
export const MONTH_OCCURRENCE_LABELS: Record<MONTH_OCCURRENCE, string> = {
  [MONTH_OCCURRENCE.FIRST]: "First",
  [MONTH_OCCURRENCE.SECOND]: "Second",
  [MONTH_OCCURRENCE.THIRD]: "Third",
  [MONTH_OCCURRENCE.FOURTH]: "Fourth",
  [MONTH_OCCURRENCE.LAST]: "Last",
};
...
export const LOCKOUT_REASON_LABELS: Record<LOCKOUT_REASON, string> = {
  [LOCKOUT_REASON.EXCESSIVE_FAILED_ATTEMPTS]: "Tentativas Excessivas de Falha",
  [LOCKOUT_REASON.IP_ABUSE_DETECTED]: "Abuso de IP Detectado",
  [LOCKOUT_REASON.PATTERN_ABUSE]: "Padrão de Abuso",
  [LOCKOUT_REASON.CAPTCHA_FAILURES]: "Falhas de CAPTCHA",
