...
// The legal MODALITY of an employment bond (vínculo). Only meaningful for on-folha CLT-family types.
...
// Stock math model on the item itself (capability field)
...
export enum FAVORITE_PAGES {
  ...
  DEPARTAMENTO_PESSOAL_AVISOS_LISTAR = "/departamento-pessoal/advertencias",
  ...
  DEPARTAMENTO_PESSOAL_AVISOS_CADASTRAR = "/departamento-pessoal/advertencias/cadastrar",
  ...
  DEPARTAMENTO_PESSOAL_AVISOS_EDITAR = "/departamento-pessoal/advertencias/editar/:id",
  ...
  DEPARTAMENTO_PESSOAL_AVISOS_DETALHES = "/departamento-pessoal/advertencias/detalhes/:id",
  ...
  DEPARTAMENTO_PESSOAL_AVISOS_EDITAR_LOTE = "/departamento-pessoal/advertencias/editar-lote",
 ...
 * - B1: 20m x 30m, B2: 18.5m x 30.5m, B3: 20m x 40m
 * - Each garage has 3 lanes (F1, F2, F3): 35m length x 3m width
 * - Lane spacing: 4m between lanes and at edges
...
export { ACTIVITY_OPERATION as ActivityOperation };
export { ACTIVITY_REASON as ActivityReason };