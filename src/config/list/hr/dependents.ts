...
export const dependentsListConfig: ListConfig<Dependent> = {
    ...
    actions: [
      {
        ...
        onPress: (dependent, router) => {
          router.push(`/recursos-humanos/dependentes/detalhes/${dependent.id}`)
        },
      },
      {
        key: 'edit',
        ...
        onPress: (dependent, router) => {
          router.push(`/recursos-humanos/dependentes/editar/${dependent.id}`)
        },
      },
      {
        key: 'delete',
  ...
  actions: {
    create: {
      ...
      route: '/recursos-humanos/dependentes/cadastrar',
