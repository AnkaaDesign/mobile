...
export const leavesListConfig: ListConfig<Leave> = {
    ...
    actions: [
      {
        ...
        onPress: (leave, router) => {
          router.push(`/recursos-humanos/medicina/afastamentos/detalhes/${leave.id}`)
        },
      },
      {
        key: 'edit',
        ...
        onPress: (leave, router) => {
          router.push(`/recursos-humanos/medicina/afastamentos/editar/${leave.id}`)
        },
      },
      {
        key: 'delete',
  ...
  actions: {
    create: {
      ...
      route: '/recursos-humanos/medicina/afastamentos/cadastrar',
