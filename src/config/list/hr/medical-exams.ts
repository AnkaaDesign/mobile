...
export const medicalExamsListConfig: ListConfig<MedicalExam> = {
    ...
    actions: [
      {
        ...
        variant: 'default',
        onPress: (exam, router) => {
          router.push(`/recursos-humanos/medicina/aso/detalhes/${exam.id}`)
        },
      },
      {
        key: 'edit',
        ...
        onPress: (exam, router) => {
          router.push(`/recursos-humanos/medicina/aso/editar/${exam.id}`)
        },
      },
      {
        key: 'delete',
  ...
  actions: {
    create: {
      ...
      route: '/recursos-humanos/medicina/aso/cadastrar',
