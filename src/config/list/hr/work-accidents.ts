...
export const workAccidentsListConfig: ListConfig<WorkAccidentReport> = {
    ...
    actions: [
      {
        ...
        onPress: (report, router) => {
          router.push(`/recursos-humanos/medicina/cat/detalhes/${report.id}`)
        },
      },
      {
        key: 'edit',
        ...
        onPress: (report, router) => {
          router.push(`/recursos-humanos/medicina/cat/editar/${report.id}`)
        },
      },
      {
        key: 'delete',
  ...
  actions: {
    create: {
      label: 'Cadastrar CAT',
      route: '/recursos-humanos/medicina/cat/cadastrar',
