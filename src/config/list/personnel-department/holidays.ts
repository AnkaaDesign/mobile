...
export const holidaysListConfig: ListConfig<Holiday> = {
    ...
    actions: [
      {
        ...
        onPress: (holiday, router) => {
          router.push(`/departamento-pessoal/feriados/detalhes/${holiday.id}`)
        },
      },
      {
        key: 'edit',
        ...
        onPress: (holiday, router) => {
          router.push(`/departamento-pessoal/feriados/editar/${holiday.id}`)
        },
      },
      {
        key: 'delete',
  ...
  actions: {
    create: {
      ...
      route: '/departamento-pessoal/feriados/cadastrar',
