...
export const ppeDeliveriesListConfig: ListConfig<PpeDelivery> = {
    ...
    actions: [
      {
        ...
        onPress: (delivery, router) => {
          router.push(`/departamento-pessoal/epi/entregas/detalhes/${delivery.id}`)
        },
      },
      {
        key: 'edit',
        ...
        onPress: (delivery, router) => {
          router.push(`/departamento-pessoal/epi/entregas/editar/${delivery.id}`)
        },
  ...
  actions: {
    create: {
      ...
      route: '/departamento-pessoal/epi/entregas/cadastrar',
