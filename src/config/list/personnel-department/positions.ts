...
export const positionsListConfig: ListConfig<Position> = {
    ...
    actions: [
      {
        ...
        onPress: (position, router) => {
          router.push(`/departamento-pessoal/cargos/detalhes/${position.id}`)
        },
      },
      {
        key: 'edit',
        ...
        onPress: (position, router) => {
          router.push(`/departamento-pessoal/cargos/editar/${position.id}`)
        },
      },
      {
        key: 'delete',
  ...
  actions: {
    create: {
      ...
      route: '/departamento-pessoal/cargos/cadastrar',
